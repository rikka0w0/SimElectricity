...
public class GuiCurrentSensor extends SEGuiContainer<ContainerCurrentSensor> {
	private static final ResourceLocation bgTexture =
			ResourceLocation.fromNamespaceAndPath(Essential.MODID, "textures/gui/current_sensor.png");
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int x, int y) {
        ...
        guiGraphics.drawString(this.font, I18n.get("gui.simelectricity.current_threshold"), 18, 85, 4210752, false);
        ...
        int ybase = 22;
        guiGraphics.drawString(this.font, I18n.get("gui.simelectricity.condition_threshold"), 10, ybase, 4210752, false);
        guiGraphics.drawString(this.font, conditionString, 10, ybase + 8, 4210752, false);
        guiGraphics.drawString(this.font, "I=" + SEUnitHelper.getCurrentStringWithUnit(this.container.current), 10, ybase + 16, 4210752, false);
        guiGraphics.drawString(this.font, "Ron = " + String.format("%.3f", this.container.resistance) + " \u03a9", 10, ybase + 24, 4210752, false);
    }
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int x, int y) {
        ...
        guiGraphics.blit(bgTexture, this.leftPos + 152, this.topPos + 44, this.container.emitRedstoneSignal ? 180 : 176, 0, 4, 16);
