...
public final class GuiRF2SE<T extends ContainerRF2SE> extends SEGuiContainer<T> {
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        ...
        this.font.drawString(I18n.format("gui.simelectricity.voltage_output"), 8, 22, 4210752);
        this.font.drawString(SEUnitHelper.getVoltageStringWithUnit(this.container.voltage), 8, 30, 4210752);
        this.font.drawString(I18n.format("gui.simelectricity.power_output"), 8, 38, 4210752);
        this.font.drawString(SEUnitHelper.getPowerStringWithUnit(this.container.actualOutputPower), 8, 46, 4210752);
