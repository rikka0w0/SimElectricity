...
public final class GuiSE2RF extends SEGuiContainer<ContainerSE2RF>{
    public GuiSE2RF(ContainerSE2RF screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
        ...
        this.font.drawString(matrixStack, I18n.format("gui.simelectricity.voltage_input"), 8, 22, 4210752);
        this.font.drawString(matrixStack, SEUnitHelper.getVoltageStringWithUnit(this.container.voltage), 8, 30, 4210752);
        this.font.drawString(matrixStack, I18n.format("gui.simelectricity.power_input"), 8, 38, 4210752);
        this.font.drawString(matrixStack, SEUnitHelper.getPowerStringWithUnit(this.container.actualInputPower), 8, 46, 4210752);
        this.font.drawString(matrixStack, I18n.format("gui.simelectricity.buffered_energy"), 8, 54, 4210752);
        this.font.drawString(matrixStack, SEUnitHelper.getEnergyStringInJ(this.container.bufferedEnergy), 8, 62, 4210752);
        ...
        this.font.drawString(matrixStack, this.container.rfOutputRateDisplay + "RF", 8, 94, 4210752);
