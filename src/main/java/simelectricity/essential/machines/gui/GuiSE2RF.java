...
public final class GuiSE2RF extends SEGuiContainer<ContainerSE2RF>{
    ...
    protected void renderLabels(PoseStack matrixStack, int x, int y) {
        ...
        this.font.draw(matrixStack, I18n.get("gui.simelectricity.voltage_input"), 8, 22, 4210752);
        this.font.draw(matrixStack, SEUnitHelper.getVoltageStringWithUnit(this.container.voltage), 8, 30, 4210752);
        this.font.draw(matrixStack, I18n.get("gui.simelectricity.power_input"), 8, 38, 4210752);
        this.font.draw(matrixStack, SEUnitHelper.getPowerStringWithUnit(this.container.actualInputPower), 8, 46, 4210752);
        this.font.draw(matrixStack, I18n.get("gui.simelectricity.buffered_energy"), 8, 54, 4210752);
        this.font.draw(matrixStack, SEUnitHelper.getEnergyStringInJ(this.container.bufferedEnergy), 8, 62, 4210752);
        this.font.draw(matrixStack, I18n.get("gui.sime_essential.rf_demand"), 8, 70, 4210752);
        this.font.draw(matrixStack, this.container.rfDemandRateDisplay + "RF", 8, 78, 4210752);
        this.font.draw(matrixStack, I18n.get("gui.sime_essential.rf_power"), 8, 86, 4210752);
        this.font.draw(matrixStack, this.container.rfOutputRateDisplay + "RF", 8, 94, 4210752);
