...
public final class GuiSwitch extends SEGuiContainer<ContainerSwitch> {
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        ...
        this.font.drawString(I18n.format("gui.simelectricity.current_trip"), 18, 85, 4210752);
        this.font.drawString(I18n.format("gui.simelectricity.resistance_internal"), 18, 124, 4210752);

        int ybase = 22;
        this.font.drawString(I18n.format("gui.simelectricity.current_trip"), 10, ybase, 4210752);
        this.font.drawString(SEUnitHelper.getCurrentStringWithUnit(this.container.maxCurrent), 10, ybase + 8, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float opacity, int par2, int par3) {
        ...
        blit(this.guiLeft + GuiSwitch.switchX, this.guiTop + GuiSwitch.switchY, this.container.isOn ? 208 : 176, 0, 32, 32);
