...
public class MetalPole35kVBER extends PowerPoleBER<BlockEntityPoleMetal35kV>{
	public MetalPole35kVBER(BlockEntityRendererProvider.Context context) {
		super(context);
	}

	@Override
	protected void bake(BlockEntityPoleMetal35kV te, PowerPoleRenderHelper helper) {
