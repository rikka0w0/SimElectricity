...
public class TransmissionTowerTopModel extends BlockRenderModel {
	...
	public TransmissionTowerTopModel(int facing, int type, TextureAtlasSprite textureMetal, TextureAtlasSprite textureInsulator) {
	...
	private static void renderInsulators(Vec3i pos, double[] from, double[] to, double[] angle, SERenderHeap modelInsulator, LinkedList<BakedQuad> quads){
		for (int i=0; i<3; i++){
