...
public class CustomModelLoader implements ICustomModelLoader {
    public static final String PATH_STI = "virtual/sti/";
    ...
    public boolean accepts(ResourceLocation modelLocation) {
        ...
        if (resPath.startsWith(CustomModelLoader.PATH_STI)) {
    ...
    public IModel loadModel(ResourceLocation modelLocation) throws Exception {
        ...
        String resPath = modelLocation.getResourcePath();
        if (resPath.startsWith(CustomModelLoader.PATH_STI)) {
            resPath = resPath.substring(CustomModelLoader.PATH_STI.length());
        ...
        if (item instanceof ISESimpleTextureItem) {
            ...
            for (ItemStack itemStack : itemStacks) {
                ...
                ModelResourceLocation res = new ModelResourceLocation(
                        domain + ":" + CustomModelLoader.PATH_STI + textureName, "inventory");
