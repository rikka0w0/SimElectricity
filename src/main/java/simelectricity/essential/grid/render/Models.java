...
public class Models {    
    ...
    public static SERenderHeap renderCableJoint(IIcon[] textures){
		...
		branch.addCube(cube, new IIcon[]{null, null, textures[0],textures[0],textures[0],textures[0]});
		...
		SERenderHelper.translateCoord(cube, 0, 0.55, 0);
		branch.addCube(cube, new IIcon[]{null,textures[1],textures[2],textures[2],textures[2],textures[2]});
