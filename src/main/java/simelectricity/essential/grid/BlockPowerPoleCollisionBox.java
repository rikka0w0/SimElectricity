...
public class BlockPowerPoleCollisionBox extends SEBlock implements ISESimpleTextureItem {
    ...
    protected final BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, BlockPowerPoleCollisionBox.propertyPart);
    }

    @Override
    public final IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(BlockPowerPoleCollisionBox.propertyPart, meta);
    }

    @Override
    public final int getMetaFromState(IBlockState state) {
        return state.getValue(BlockPowerPoleCollisionBox.propertyPart);
    }

    @Override
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        int part = state.getValue(BlockPowerPoleCollisionBox.propertyPart);
