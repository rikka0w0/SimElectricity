 ...
 */
public interface ISEGridBlockEntity {
    ISEGridNode getGridNode();

    /**
     * This function will be called by the grid manager once a ISEGridObject is going to associate with the ISEGridBlockEntity
     * <p/>
