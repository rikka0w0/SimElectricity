...
public class TileIC2Generator extends TileStandardSEMachine implements IEnergySource {
    ...
    //IC2------------------------------------------------------------------------------------------
    @Override
    public boolean emitsEnergyTo(TileEntity paramTileEntity, EnumFacing paramForgeDirection) {
        return true;
    }
...
/**
     ...
     *
     * @param paramDouble amount of EU to draw, may be negative
     *//*
