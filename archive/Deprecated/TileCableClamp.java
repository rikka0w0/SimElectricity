...
import simElectricity.Templates.Client.Render.IHVTower;
import simElectricity.Templates.Common.TileEntitySE;
import simElectricity.Templates.Utils.Utils;

public class TileCableClamp extends TileEntitySE implements ISETile,ISEJunctionData,ISEGridTile, IHVTower{
	...
	public void getNeighbors(List<ISESimulatable> list) {
		TileEntity neighbor = Utils.getTileEntityonDirection(this, ForgeDirection.getOrientation(facing));
	...
	public void onGridNeighborUpdated() {
		...
		SEAPI.networkManager.updateTileEntityFields(this, "neighbor");
	}
